document.addEventListener('DOMContentLoaded', () => {
    ...
    function generatePageContent(pageId) {
        ...
        // --- Ajout de l'image principale de la page (hero image) si elle existe ---
        if (page.image) {
            const pageImage = document.createElement('img');
            // Assurez-vous que page.image est "images/nom_image.jpg"
            pageImage.src = `${ASSETS_BASE_URL}images/${page.image}`; // <-- CORRECTION ICI pour les images de page
